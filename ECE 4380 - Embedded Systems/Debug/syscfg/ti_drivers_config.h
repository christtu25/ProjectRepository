...
#define CONFIG_TIMER_0              1
extern const uint_least8_t          TICKER_TIMER_1_CONST;
#define TICKER_TIMER_1              2
extern const uint_least8_t          TICKER_TIMER_0_CONST;
#define TICKER_TIMER_0              3
